Ext.define('FastExt.view.VGrid', {
    extend: 'Ext.grid.Panel',
    requires: ['FastExt.store.MListMgr', 'FastExt.view.vfield.VFieldFactory','FastExt.view.DataFieldFactory', 'FastExt.view.GridColumnFactory'],
    tab: {},
    selType: 'rowmodel',
    multiSelect: false,
    border: false,
...
//        });
    ...
    getGFields: function () {
        ...
        Ext.each(this.getMColumns(), function (column) {
            ...
            FastExt.view.DataFieldFactory.buildField(fields,column);
            //fields.push(FastExt.view.vfield.VFieldFactory.buildField(column, this.tab.winCtx, this.tab.winId, this.tab.rest).data());
        }, this);
        return fields;
    },
    ...
    getGColumns: function () {
        ...
        Ext.each(this.getMColumns(), function (column) {
            ...
            FastExt.view.GridColumnFactory.buildColumn(columns, column);
            //alert('ss');
            //columns.push(FastExt.view.vfield.VFieldFactory.buildField(column, this.tab.winCtx, this.tab.winId, this.tab.rest).column());
        }, this);
        return columns;
    },
